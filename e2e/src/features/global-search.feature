Feature: Global search
  ...
  @run
  Scenario: Mouse hover global search
  ...
  Scenario: Search for a Turma
    Given I click on "Menu Item" button on "Nav Menu" that has the text "Adicionar Turma"
    ...
    And I click on "search result" link on "Nav Menu" that has the text "Turma: Calculo"
